      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-[var(--text-secondary)] max-w-2xl mx-auto mb-8">
            Tu planificador financiero personal. Organizá tus gastos, analizá tus hábitos y tomá
            mejores decisiones con inteligencia artificial.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Step
              number={1}
              title="Registrate"
              description="Creá tu cuenta en segundos. Sin tarjeta de crédito, sin compromiso."
            />
            <Step
              number={2}
              title="Registrá gastos"
              description="Escribile al bot de Telegram o cargá gastos desde la web. La IA se encarga del resto."
            />
            <Step
              number={3}
              title="Analizá"
