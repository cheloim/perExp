  ...
  return (
    <div className="min-h-screen bg-[var(--color-base)] py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <a href="/" className="inline-flex items-center gap-2 text-sm text-[var(--text-tertiary)] hover:text-[var(--text-primary)] transition mb-8">
          ← Volver a oikonomia
        </a>
        ...
        <div className="prose prose-sm max-w-none text-[var(--text-secondary)] space-y-6">
          ...
          <Section title="3. Almacenamiento y seguridad">
            <p>
              ...
              Utilizamos cifrado en tránsito (TLS) y en reposo. Las contraseñas se almacenan
              con bcrypt (hash unidireccional). Las sesiones utilizan JWT con expiración configurable.
            </p>
          </Section>
          ...
          <Section title="4. Servicios de terceros">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li><strong>Resend:</strong> envío de emails transaccionales (verificación, recuperación de contraseña).</li>
          ...
          <Section title="6. Cookies y tracking">
            <p>
              oikonomia no utiliza cookies de rastreo ni publicidad. La única cookie utilizada
              es para mantener tu sesión de inicio de fecha (JWT en localStorage).
            </p>
          </Section>
          ...
          <Section title="8. Contacto">
            <p>
              ...
              de tus datos, contactanos a{' '}
              <a href="mailto:contacto@oikonomia.ar" className="text-[var(--color-primary)] hover:underline">
