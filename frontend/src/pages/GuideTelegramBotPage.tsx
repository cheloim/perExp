    ...
    <div className="min-h-screen bg-[var(--color-base)]">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[var(--text-secondary)]">
                Registrá gastos, recibí alertas y controlá tus finanzas desde
                Telegram
              </p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Section
          id="que-es"
          icon="telegram"
          title="¿Qué es el bot de Telegram?"
        >
          <p>
            <strong>@NikoFin_bot</strong> es tu asistente de finanzas personales
            en Telegram. Te permite{" "}
            <strong>registrar gastos en segundos</strong> escribiendo de forma
            natural, como si se lo contaras a un amigo.
          </p>
          <p>
            No necesitás abrir la app ni navegar menús. Desde Telegram podés
            cargar gastos, recibir alertas de presupuesto y hasta reenviar
            notificaciones de tu banco para que se registren automáticamente.
          </p>
          <div className="p-4 rounded-xl bg-[var(--color-primary)]/5 border border-[var(--color-primary)]/20">
            <p className="text-sm">
              <strong>💡 Ejemplo:</strong> Le escribís "farmacity 3200" y el bot
              te responde con el gasto parseado, te pide el medio de pago y lo
              guarda. Todo en menos de 10 segundos.
            </p>
          </div>
        </Section>
        ...
        <Section id="vincular" icon="bot" title="Cómo vincular tu cuenta">
          <p>
            Para que el bot sepa quién sos, necesitás vincular tu cuenta de la
            app con Telegram. Se hace una sola vez.
          </p>
          <Steps
            items={[
          ...
          <div className="mt-3 p-3 rounded-lg border border-[var(--border-color)]">
            ...
            <p className="text-xs text-[var(--text-secondary)]">
              La clave de un solo uso. Después de vincular, se invalida
              automáticamente. Si necesitás reconectar, desde la app podés
        ...
        <Section id="registrar" icon="bot" title="Cómo registrar gastos">
          <p>
            Escribile al bot de forma natural. No hace falta usar comandos
            especiales ni seguir un formato rígido.
          </p>
          ...
          <p>
            El bot usa inteligencia artificial para entender tu mensaje: detecta
            el monto, la descripción, la fecha y hasta la categoría
            automáticamente.
          </p>
          <Steps
            items={[
        ...
        >
          <p>
            Si tu banco te manda notificaciones por SMS o push cuando usás la
            tarjeta, podés
            <strong> reenviarlas directamente al bot</strong>. Las detecta
            automáticamente y extrae el monto, la tarjeta y el comercio.
          </p>
          <div className="p-3 rounded-lg border border-[var(--border-color)] space-y-2">
            <p className="text-xs font-semibold text-[var(--text-primary)]">
          ...
          <p>
            El bot detecta automáticamente la franquicia (Visa, Mastercard,
            etc.) y el banco. Si reconoce tu tarjeta, te muestra toda la info
            junta para que solo confirmes.
          </p>
        </Section>
        ...
        <Section id="cuotas" icon="bot" title="Seguimiento de cuotas">
          <p>
            Si pagaste algo en cuotas, el bot te pregunta automáticamente
            después de registrar el gasto. Solo tenés que indicar cuántas cuotas
          ...
          <div className="mt-3 p-3 rounded-lg border border-[var(--border-color)]">
            ...
            <p className="text-xs text-[var(--text-secondary)]">
              Comprás un celular en 12 cuotas de $10.000. El bot crea 12 gastos
              de $10.000, uno por mes, para que veas el impacto real en tu
        ...
        <Section id="alertas" icon="bell" title="Alertas de presupuesto">
          <p>
            El bot está conectado con tu sistema de presupuestos. Cuando un
            gasto te hace superar un límite, recibís una alerta directa en
            Telegram.
          </p>
          <div className="space-y-2">
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Te avisa que te estás acercando al límite para que puedas
                ajustar.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
            ...
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Cada mañana el bot revisa todos tus grupos y categorías y te
                manda un resumen si hay alertas pendientes.
              </p>
            </div>
          </div>
        </Section>
        ...
        <Section id="eventos" icon="bot" title="Eventos temporales">
          <p>
            Si tenés un evento temporal configurado (vacaciones, un viaje, un
            casamiento), el bot te pregunta si un gasto pertenece a ese evento
            cuando la fecha coincide.
          </p>
          <Steps
            items={[
          ...
          <div className="mt-3 p-3 rounded-lg border border-[var(--border-color)]">
            ...
            <p className="text-xs text-[var(--text-secondary)]">
              Tenés el evento "Vacaciones Europa" del 1 al 15 de julio. Si el 5
              de julio le escribís "hotel 85000", el bot te pregunta si
              pertenece a Vacaciones Europa para vincularlo automáticamente.
            </p>
          </div>
        </Section>
        ...
        <Section id="comandos" icon="telegram" title="Comandos disponibles">
          <div className="space-y-2">
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Inicia la conversación. Si ya estás vinculado, te muestra un
                resumen. Si no, te pide la clave de vinculación.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              <p className="text-xs font-semibold text-[var(--text-primary)]">
          ...
          <p className="mt-2 text-sm">
            <strong>Tip:</strong> También podés escribir "ayuda" en cualquier
            momento y el bot te muestra los ejemplos.
          </p>
        </Section>
        ...
        <Section id="consejos" icon="sparkles" title="Consejos para mejor uso">
          <div className="space-y-3">
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                No necesitás memorizar comandos. Escribí como le hablarías a
                alguien: "gasté 5000 en el supermercado ayer" funciona perfecto.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              <p className="text-xs font-semibold text-[var(--text-primary)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Si tu banco te manda SMS o push notifications, reenvialas al
                bot. Detecta el monto, la tarjeta y el comercio automáticamente.
                Es la forma más rápida de registrar.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              <p className="text-xs font-semibold text-[var(--text-primary)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                El bot es ideal para registrar gastos en el momento, cuando no
                tenés tiempo de abrir la app. Después podés revisar todo en la
                web.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Si el gasto fue ayer, la semana pasada o una fecha específica,
                mencionalo: "uber 3200 ayer" o "cena el viernes 15000". El bot
                entiende fechas relativas y absolutas.
              </p>
            </div>
            <div className="p-3 rounded-lg border border-[var(--border-color)]">
              <p className="text-xs font-semibold text-[var(--text-primary)]">
              ...
              <p className="text-xs text-[var(--text-secondary)]">
                Cuando el bot te mande una alerta de presupuesto, tómala como
                una señal para revisar tus gastos en la app y ajustar si es
                necesario.
              </p>
            </div>
          </div>
