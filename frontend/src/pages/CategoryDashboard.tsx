    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div
          ...
          style={
            activeSelection
              ? { borderTopColor: activeSelection.color, borderTopWidth: "2px" }
              : undefined
          }
        >
          ...
          <div className="flex items-baseline gap-2">
            ...
            {pctChange !== null && (
              <span
                className={`text-xs font-medium ${pctChange >= 0 ? "text-danger" : "text-success"}`}
              >
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-xs">
                <div className="text-[var(--text-primary)] font-semibold text-base">
                  {formatCurrency(activeSelection.total)}
                </div>
                <div className="text-[var(--text-secondary)]">
                  {activeSelection.count} transacciones
                </div>
                {grandTotal > 0 && (
                  <div className="text-[var(--text-secondary)]">
                  ...
                  return (
                    <div key={i} className="flex items-center gap-3 group/merchant">
                      ...
                      <button
                        onClick={() =>
                          navigate(
                            `/expenses?search=${encodeURIComponent(m.description)}&month=${month}`,
                          )
                        }
