...
export function AutocompleteInput({ value, onChange, onSelect, options, placeholder }: AutocompleteInputProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 z-[70] bg-[var(--color-surface)] border border-[var(--border-color)] rounded-md shadow-lg max-h-40 overflow-y-auto">
