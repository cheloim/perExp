...
export default function NotificationsPanel({ onClose }: Props) {
  ...
  return (
    <>
      ...
      <div
        className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom,0px))] left-4 z-40 w-80 bg-[var(--color-surface)] border border-[var(--border-color)] rounded-lg shadow-gnome-lg flex flex-col max-h-[480px]"
        role="dialog"
