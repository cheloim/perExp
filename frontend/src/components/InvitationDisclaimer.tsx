...
export default function InvitationDisclaimer({
  notificationId,
  inviterName,
  onClose,
}: Props) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-base-container/60">
      <div className="bg-surface border border-border-color rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6">
        ...
        <p className="text-secondary text-sm mb-3">
          Al aceptar,{" "}
          <span className="text-primary font-medium">tú y {inviterName}</span>{" "}
          podrán ver los gastos e información financiera de ambos. Esta es una
