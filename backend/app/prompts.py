...
- "card_header": encabezado de sección de tarjeta que identifica a qué tarjeta pertenece la transacción. Ej: "Visa Galicia", "Mastercard Santander". Si no hay secciones múltiples o no se detecta header, devolvé "".
